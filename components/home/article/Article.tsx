    ...
    <div className="grid md:grid-cols-2 grid-cols-1 md:my-20 my-10">
      ...
      <div className="grid grid-cols-2 gap-5">
        <div className="grid gap-5 justify-items-end">
          <Image src="/image2.webp" alt="Test" width={350} height={200} />
          <Image src="/image1.webp" alt="Test" width={250} height={200} />
        </div>
        <Image src="/image3.webp" alt="Test" width={250} height={200} />
      </div>
    </div>
  );
};
