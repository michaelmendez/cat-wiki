...
export default async function handler(
  ...
  res: NextApiResponse<CatBreedImageData[] | ErrorResponse>
) {
  try {
    let response: CatBreedImageData[] | CatBreedDBCollection[] = [];
    ...
    if (orderBy) {
      ...
      const catBreedsFiltered = filterBreeds(search, catBreeds, limit);
